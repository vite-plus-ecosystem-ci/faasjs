...
import { loadPackage, resetRuntime } from '../../load-package'

const execFileAsync = promisify(execFile)
const loadPackageModuleURL = new URL('../index.ts', import.meta.url).href
const registerHooksIndexHref = new URL('../../register-hooks/index.ts', import.meta.url).href
...
describe('register-hooks preload', () => {
  const tempDirs: string[] = []
